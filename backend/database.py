...
class Database:
    ...
    """, (
        ...
        incident.get("ip"),
        incident.get("countrycode"),
        incident.get("countryname"),
        incident.get("regioncode"),
        incident.get("regionname"),
        incident.get("city"),
        incident.get("zipcode"),
        ...
        incident.get("title"),
        incident.get("date"),
        incident.get("date_update"),
        incident.get("hash"),
        incident.get("score"),
        incident.get("host"),
        incident.get("domain"),
        incident.get("tld"),
        incident.get("domain_registered_n_days_ago"),
        incident.get("screenshot"),
        incident.get("abuse_contact"),
        incident.get("ssl_issuer"),
        incident.get("ssl_subject"),
        incident.get("rank_host"),
        incident.get("rank_domain"),
        incident.get("n_times_seen_ip"),
        incident.get("n_times_seen_host"),
        incident.get("n_times_seen_domain"),
        incident.get("http_code"),
        incident.get("http_server"),
        incident.get("google_safebrowsing"),
        incident.get("virus_total"),
        incident.get("abuse_ch_malware"),
        incident.get("vulns"),
        incident.get("ports"),
        incident.get("os"),
        incident.get("tags"),
        incident.get("technology"),
        incident.get("page_text"),
        incident.get("ssl_fingerprint"),
    ))
